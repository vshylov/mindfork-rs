...
up to two seconds for the cancelled task's own landing, then deciding by
its state — [quit-waits-for-the-landing.md](docs/research/quit-waits-for-the-landing.md),
