...
- **The app's own work** — the four silent tasks (reflection, notes
  ...
  *running*, *waiting* or *idle*: *waiting* is a slot taken with no stream
  ...
  or waiting for room beside a turn ([6.3](#63-client-side-agentic-loop));
  read off the budget, never stored. There is no last-run time and no last
