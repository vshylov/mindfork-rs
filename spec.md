...
- **A `python_exec` call also states what would go into the sandbox**: the chat's
  ...
  ([docs/sandbox-file-exchange.md](docs/sandbox-file-exchange.md) §12 T6).
