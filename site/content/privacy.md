...
companions: [SECURITY.md](https://github.com/vshylov/mindfork-rs/blob/main/SECURITY.md) (what the app promises, and how to report
a break), [DISCLAIMER.md](https://github.com/vshylov/mindfork-rs/blob/main/DISCLAIMER.md) §5 (what it means, legally, that a
request leaves your machine), and [docs/install.md](https://github.com/vshylov/mindfork-rs/blob/main/docs/install.md) (where the
...
([docs/install.md](https://github.com/vshylov/mindfork-rs/blob/main/docs/install.md)). In a development build that is
...
[ADR 0008](https://github.com/vshylov/mindfork-rs/blob/main/docs/decisions/0008-api-key-storage.md): it defends against a
...
([infra/website.cfn.yaml](https://github.com/vshylov/mindfork-rs/blob/main/infra/website.cfn.yaml)) configures **no access
...
private channel ([SECURITY.md](https://github.com/vshylov/mindfork-rs/blob/main/SECURITY.md)).
...
[CHANGELOG.md](https://github.com/vshylov/mindfork-rs/blob/main/CHANGELOG.md).
...
[SECURITY.md](https://github.com/vshylov/mindfork-rs/blob/main/SECURITY.md) rather than a public issue.
