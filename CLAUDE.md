...
- **Тесты**: notes (recall/ворота/обзор скрывают self; supersede/merge наследуют теги;
  ...
  **711 тестов зелёные**, clippy/fmt чисты. **Оценка зонда на живой модели (критерии
  go/no-go — Шаг 8 дизайн-дока: срабатывают ли ворота, находит ли семантика старые
  инсайты, не всплывают ли self-заметки в обычном recall) — ручной шаг пользователя.**
