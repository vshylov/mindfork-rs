...
- **Завершение направления i18n** (дизайн-план [docs/i18n-external-locales.md](docs/i18n-external-locales.md),
  ...
  масштаба (§4.3 docs/i18n.md) взята полной по решению пользователя (2026-07-13).
...
- **Постановка пользователя (2026-07-14):** переместить в бандлы переводов **весь**
  ...
  план [docs/i18n-cli.md](docs/i18n-cli.md), 3 этапа; это **этап 1** (`feat/cli-i18n-bootstrap`).
...
- **Тесты:** парсер (`features/cli.rs`, 13 — все подкоманды/формы опций/ошибки/`-c` вне
  ...
  код выхода 2 у ошибок разбора. Доки: architecture.md §3/§12, docs/i18n-cli.md.
