...
Сделан весь план **M0–M9** плюс обширный пост-M9 (в `main`). **1093 юнит-теста
...
непубличной LameLLaMA уезжает в приватный внешний конвертер); следующий этап —
зонд `spike/mcp-client` (go/no-go на живой модели); прежнее направление —
