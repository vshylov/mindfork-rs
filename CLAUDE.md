...
- **[docs/decisions/](docs/decisions/)** — ADR: UI-крейты под ratatui 0.30 (0001),
  ...
  нейтральный формат обмена импорта (0007).
...
Сделан весь план **M0–M9** плюс обширный пост-M9 (в `main`). **1192 юнит-теста
зелёные, 53 `#[ignore]`-смоука** (крупнейший счётчик — журнал ниже; текущее
направление — **API-ключи в настройках** (машинно-привязанное шифрование в конфиге;
исследование [docs/research/api-key-storage.md](docs/research/api-key-storage.md),
развилки Р1–Р6 приняты 2026-07-20) — **этап 1 «ядро» сделан**, этап 2 «UI» — далее;
