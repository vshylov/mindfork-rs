...
Сделан весь план **M0–M9** плюс обширный пост-M9 (в `main`). **1253 юнит-теста
зелёные, 56 `#[ignore]`-смоуков** (крупнейший счётчик — журнал ниже; текущее
...
- **Тесты**: парсер команды (7), речевой экстрактор (15, включая golden на
  ...
  **1253 юнит-теста зелёные** (+54 к main), **56 `#[ignore]`** (+3 живых смоука:
  OpenAI, Gemini, сторонний сервер), clippy `-D warnings`/fmt/`cargo deny` чисты.
