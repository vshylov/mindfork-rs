...
Сделан весь план **M0–M9** плюс обширный пост-M9 (в `main`). **1098 юнит-тестов
зелёные, 49 `#[ignore]`-смоуков** (крупнейший счётчик — журнал ниже; текущее
...
14 инструментов ≈ 7 КиБ схем, протокол 2025-11-25); следующий этап —
`feat/mcp-host`; прежнее направление —
