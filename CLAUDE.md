...
## Статус (на 2026-07-20, версия 0.9.1)
Сделан весь план **M0–M9** плюс обширный пост-M9 (в `main`). **1199 юнит-тестов
зелёные, 53 `#[ignore]`-смоука** (крупнейший счётчик — журнал ниже; текущее
направление — **API-ключи в настройках** (ввод в окне настроек + машинно-привязанное
