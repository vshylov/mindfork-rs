...
| working on **memory** — self-model, notes, RAG, attachments, embeddings | architecture §9 · spec §9.5, §17 · [docs/journal/memory.md](docs/journal/memory.md) |
...
| working on **packaging, CI, releases, dev tooling** | architecture §12 · AGENTS.md §6 · [docs/journal/platform.md](docs/journal/platform.md) |
...
## Status (2026-08-08, version 0.9.4)
