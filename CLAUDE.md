...
Сделан весь план **M0–M9** плюс обширный пост-M9 (в `main`). **1180 юнит-тестов
зелёные, 53 `#[ignore]`-смоука** (крупнейший счётчик — журнал ниже; текущее
направление — **айдентика** (логотип/вордмарк: ассеты, иконка `.exe`, запись в меню
Linux, логотип в справке; план [docs/branding.md](docs/branding.md)) — **завершено**;
прежнее — **система плагинов** — **завершено** (исследование
