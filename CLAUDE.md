...
Сделан весь план **M0–M9** плюс обширный пост-M9 (в `main`). **1254 юнит-теста
...
экстрактор markdown, плеер `rodio`, провайдеры OpenAI/Gemini/external, вкладка
«Озвучивание» в настройках; исследование
[docs/research/tts.md](docs/research/tts.md), развилки Р1–Р9 приняты 2026-07-21) —
**этап 1 завершён**, этап 2 (локальный сайдкар) впереди; прежнее —
