...
> Статус: **план / условный задел** (делать «при кратном росте числа заметок»).
> Закрывает задел roadmap раздела «Память, модель себя, знания». При финализации
> документ переезжает в `docs/history/`.
