...
Дизайн-план направления (жанр по AGENTS.md §1). Статус: **развилки подтверждены
пользователем (2026-07-15) — по рекомендациям [рек.] во всех блоках А–Г**;
реализация по этапам §4. После завершения направления — переезд в `docs/history/`.
