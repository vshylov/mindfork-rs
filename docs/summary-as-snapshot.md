...
Структура — как у [refinements.md](history/refinements.md): этапы = отдельные PR,
каждый с кодовыми набросками, тестами и оценкой объёма. Философия — та же, что у
[notes-connectivity](history/notes-connectivity.md) / [narrative-as-notes](history/narrative-as-notes.md):
