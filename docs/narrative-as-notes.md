...
**Осталось (Шаг 8, ручной шаг пользователя):** оценка зонда на живой модели —
срабатывают ли **ворота** (переписывает ли модель почти-дубль через
`note_revise`/`note_supersede`), находит ли семантическое чтение старые инсайты, не
всплывают ли self-заметки в обычном `note_recall`. Критерий go/no-go — переходить ли
к Ярусу 2 (граф над self-заметками / релевантность-инъекция / связывание органов).
