# Disclaimer — AI models, generated output, and automated actions

This notice **supplements and does not modify** the MIT License in the
[accompanying file](LICENSE). The MIT License is reproduced there verbatim and
...
[MIT License](LICENSE), do not use this software.
