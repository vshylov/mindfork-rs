...
- **Озвучивание сообщений чата** — команда `/tts` в поле ввода: `/tts` читает
  ...
  на новой вкладке «Озвучивание» секции «Модель»: облако OpenAI, облако Gemini или
  любой сторонний OpenAI-совместимый TTS-сервер; API-ключ облака — тот же, что уже
  введён для чата. Там же — голос, указания по тону, скорость и поведение
