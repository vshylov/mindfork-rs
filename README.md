...
- **Cross-chat search for the assistant** — off by default. Enable
  ...
  the one you pick. An address for a conversation that isn't yours to open
...
| `Ctrl+B` | emoji picker |
| `Ctrl+L` | follow a `chat://` reference the assistant wrote (a picker of the conversations this chat links to) |
